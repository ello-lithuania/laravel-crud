...
@section('content')
<section class="hero-area" style="margin: 0; padding-top: 1.5rem;">
<div class="container">
<div class="row">
...
<div class="single-slider" style="background-image: url(assets/images/hero/pexels-photo-5493664.jpg);">
<div class="content" style="background:rgba(230,225,231, 0.8);">
<h2><span>Vidaus apdailos darbai</span>
Grindų, sienų, lubų ir visi kiti vidaus apdailos darbai
</h2>
<p class="hidden">Pasiūlykite savo statybos paslaugas, </p>
<h3 class="hidden"><span>Now Only</span> $320.99</h3>
...
<div class="single-slider" style="background-image: url(assets/images/hero/pexels-photo-549366445.jpg);">
<div class="content" style="background:rgba(230,225,231, 0.8);">
<h2><span>Metalo gaminiai, suvirintojai</span>
Įvairūs daiktai, kaip laiptai, lentynos ar kiti metalo gaminiai
</h2>
<p class="hidden">Pasiūlykite savo statybos paslaugas, </p>
<h3 class="hidden"><span>Now Only</span> $320.99</h3>
<div class="button hidden">
...
<div class="hero-small-banner" style="background-image: url('assets/images/hero/pexels-photo-549366454.jpg');">
<div class="content" style="background:rgba(230,225,231, 0.8);">
<h2>
<span>Elektrikai, elektros darbai</span>
Elektros laidų, sistemų ir įrenginių pajungimas ir remontas
</h2>
<h3 class="hidden">$259.99</h3>
</div>
</div>
...
<div class="content">
<h2>Sukurkite naują skelbimą</h2>
 <p>Praneškite apie savo paslaugas internete!</p>
<div class="button">
<a class="btn" href="{{route('advertisement-form');}}">Naujas skelbimas</a>
</div>
</div>
</div>
...
<section class="featured-categories section hidden">
<div class="container">
<div class="row">
<div class="col-12">
<div class="section-title">
<h2>Populiarios kategorijos</h2>
<p class="hidden">Atrinkome populiariausios skelbimų kategorijos</p>
</div>
</div>
</div>
<div class="row">
...
<p class="hidden">There are many variations of passages of Lorem Ipsum available, but the majority have
...
@foreach($new_advertisements as $new_ad)
...
<section class="special-offer section hidden">
<div class="container">
<div class="row">
<div class="col-12">
<div class="section-title">
...
<div class="single-banner right hidden" style="background-image:url('assets/images/banner/banner-3-bg.jpg');margin-top: 30px;">
<div class="content">
...
<section class="home-product-list section hidden">
<div class="container">
<div class="row">
...
<section class="blog-section section hidden">
<div class="container">
<div class="row">
<div class="col-12">
<div class="section-title">
...
<section class="shipping-info hidden">
<div class="container">
<ul>
